...
public class SimpleLinkedList implements List {
    ...
    public Object removeFirst() throws ListEmptyException {
        ...
        if (isEmpty()) {
            throw new ListEmptyException("List.List is empty");
        }
    ...
    public Object removeLast() throws ListEmptyException {
        // Check if list is empty
        if (isEmpty()) {
            throw new ListEmptyException("List.List is empty - cannot remove from end");
        }
    ...
    public void printList() {
        ...
        System.out.print("List.List contents: ");
        SLListNode current = head;
        while (current != null) {
